export default class HapiRequestToken {
  constructor(hapiRequest, tokenOptions) {
    HapiRequestToken.DEFAULT_TOKEN_PARAMETER = 'token';
    ...
    HapiRequestToken.DEFAULT_OPTIONS = {
      ...
      header: true,
      query: { name: HapiRequestToken.DEFAULT_TOKEN_PARAMETER },
      payload: { name: HapiRequestToken.DEFAULT_TOKEN_PARAMETER },
    };
  ...
  _extractTokenFromQuery() {
    ...
    const tokenParameterName = this._tokenOptions.query.name
      || HapiRequestToken.DEFAULT_TOKEN_PARAMETER;
    return this._hapiRequest.query[tokenParameterName] || null;
  }
  ...
  _extractTokenFromPayload() {
    ...
    const tokenParameterName = this._tokenOptions.payload.name
      || HapiRequestToken.DEFAULT_TOKEN_PARAMETER;
    return this._hapiRequest.payload[tokenParameterName] || null;
  }
}
